...
config PM_PARTITION_SIZE_TFM_SRAM
	...
	default 0x13000 if (SOC_SERIES_NRF54LX || SOC_SERIES_NRF71X)
...
config PM_PARTITION_SIZE_TFM
	...
	default 0x6800 if TFM_PROFILE_TYPE_MINIMAL && BOOTLOADER_MCUBOOT && (SOC_NRF54L15_CPUAPP || SOC_NRF7120_ENGA_CPUAPP)
